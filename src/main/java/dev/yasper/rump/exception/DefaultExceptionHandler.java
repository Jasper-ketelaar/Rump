...
/**
 * Default exception handling implementation. This handler will throw any
 * status exception that it gets. See {@link dev.yasper.rump.config.RequestConfig#setExceptionHandler(ExceptionHandler)}
